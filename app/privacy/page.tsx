    ...
    <>
        ...
        <div className="bg-background text-on-background py-8 px-4">
            <div className="container mx-auto">
                <h1 className="text-4xl uppercase font-bold mb-6 text-center text-primary">
                    Privacy Policy</h1>
                ...
                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">1. Information We Collect</h2>
                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">1.1 Personal Data</h3>
                <p className="mb-4">
                    Personally identifiable information, such as your name, shipping address, email address, and telephone number, and demographic information, such as your age, gender, hometown, and interests, that you voluntarily give to us when you register with the Site or when you choose to participate in various activities related to the Site, such as online chat and message boards.
                </p>

                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">1.2 Derivative Data</h3>
                <p className="mb-4">
                    Information our servers automatically collect when you access the Site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the Site.
                </p>

                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">1.3 Financial Data</h3>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">2. Use of Your Information</h2>
                ...
                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">3. Disclosure of Your Information</h2>
                ...
                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">3.1 By Law or to Protect Rights</h3>
                <p className="mb-4">
                    If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation.
                </p>

                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">3.2 Business Transfers</h3>
                <p className="mb-4">
                    We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.
                </p>

                <h3 className="text-xl font-semibold mt-4 mb-2 text-secondary">3.3 Third-Party Service Providers</h3>
                <p className="mb-4">
                    We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.
                </p>

                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">4. Security of Your Information</h2>
                <p className="mb-4">
                    We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
                </p>

                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">5. Policy for Children</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">6. Cookies and Tracking Technologies</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-bold mt-6 mb-4 text-primary">7. Changes to This Privacy Policy</h2>
                <p className="mb-4">
