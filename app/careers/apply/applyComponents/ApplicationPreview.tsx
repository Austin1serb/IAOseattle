				...
				<div className="w-full max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg mb-24">
					...
					<div className="mb-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
							<p>
								First Name: <span className="text-blue-600 capitalize">{formData.firstName}</span>
							</p>
							<p>
								Last Name: <span className="text-blue-600 capitalize">{formData.lastName}</span>
							</p>
							<p>
								Preferred Name: <span className="text-blue-600 capitalize">{formData.preferredName}</span>
							</p>
							<p>
								Preferred Pronouns: <span className="text-blue-600">{formData.preferredPronouns}</span>
							</p>
							<p>
								Date of Birth: <span className="text-blue-600">{formData.dob}</span>
							</p>
						</div>
					</div>
					...
					<div className="mb-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
							<p>
								Email: <span className="text-blue-600">{formData.email}</span>
							</p>
							<p>
								Phone: <span className="text-blue-600">{formData.phone}</span>
							</p>
						</div>
					</div>
					...
					<div className="mb-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
							<p>
								Street Address: <span className="text-blue-600">{formData.street}</span>
							</p>
							<p>
								Street Address 2: <span className="text-blue-600">{formData.street2 || "N/A"}</span>
							</p>
							<p>
								City: <span className="text-blue-600 capitalize">{formData.city}</span>
							</p>
							<p>
								State: <span className="text-blue-600 uppercase">{formData.state}</span>
							</p>
							<p>
								Zip Code: <span className="text-blue-600">{formData.zipCode}</span>
							</p>
						</div>
					</div>
					...
					<div className="mb-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
							<p>
								How did you hear about this position? <span className="text-blue-600 capitalize">{formData.heardAboutPosition}</span>
							</p>
							<p>
								Referral Name: <span className="text-blue-600 capitalize">{formData.referralName || "N/A"}</span>
							</p>
							<p>
								Start Date: <span className="text-blue-600">{formData.startDate}</span>
							</p>
						</div>
					</div>
