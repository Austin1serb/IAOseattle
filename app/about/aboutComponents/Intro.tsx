        ...
        <section className="bg-gray-300 py-24">
            <div className="max-w-5xl mx-auto">
                <div className="flex items-center justify-center flex-col md:flex-row pb-8 px-8">
                    <div className="h-1/2 w-1/2 -translate-x-4">
                        <IaoIcon />
                    </div>
                    <h2 className="text-4xl lg:text-[55px] mb- text-start z-10 relative text-nowrap">
                        <strong className="text-shadow-white">Redefining</strong> Private Security
                        <div className="absolute w-[98%] bg-black min-h-[4px] mt-1 ml-1 z-10"></div>
                    </h2>
                </div>
                    ...
                    <div className="flex-1">
                        <div className="relative float-right h-auto ml-4 mb-8 rounded z-10">
                            <Image
                                ...
                                width={300}
                            />
                            <p className="text-gray-400 text-right">- Image Description</p>
                            <div className="
                            absolute top-8 left-20 -z-1 w-full h-full border-[12px] border-blue-600 rounded"></div>
                        </div>
